...
const WinningItem = ({
  ...
  const handleAddToCart = async () => {
    ...
    // Refresh the cart by getting the latest state
    const updatedCart = await getOrCreateCart(cartId);
...
const WheelOfFortune = ({ products, winningIndex }: WheelOfFortuneProps) => {
  ...
  // Remove the automatic popup effect
  // The wheel will now only show when explicitly triggered
